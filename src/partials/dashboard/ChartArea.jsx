...
function ChatArea() {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-12 bg-gray-100 dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4 mt-4">
      <header className="px-5 py-4 border-b border-slate-100 dark:border-slate-700 flex items-center">
        <img src="./src/images/AfriCare.png" height={48} width={48} alt="Logo" />
        <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 ml-4">Live Chat</h2>
      </header>
      <div className="chat-messages bg-white dark:bg-slate-700 p-4 rounded-sm overflow-y-auto h-64 mt-2">
      ...
      <form onSubmit={handleSendMessage} className="flex items-center mt-2">
        ...
        <button
          type="submit"
          className="bg-blue-500 text-white p-2 rounded-sm ml-2 flex items-center justify-center"
        >

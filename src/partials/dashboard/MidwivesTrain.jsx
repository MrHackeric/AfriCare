...
function MidwivesTrainingModule() {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-5">
      <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">Midwives Training Module</h2>
      <div className="text-slate-800 dark:text-slate-100 mb-4">
        <p>Welcome to the training module for midwives. In this module, you will learn about various aspects of maternal care, including prenatal, delivery, and postnatal care. Please read the following content carefully and answer the questions below.</p>
        <h3 className="text-md font-semibold mt-4">Training Content:</h3>
        <p>1. Prenatal Care: Regular prenatal visits are crucial for monitoring the health of the mother and the developing fetus. These visits should include routine check-ups, screenings, and vaccinations.</p>
        <p>2. Delivery: Proper techniques and protocols must be followed during delivery to ensure the safety of both the mother and the baby. This includes managing labor pain, monitoring fetal heart rate, and being prepared for any complications.</p>
        <p>3. Postnatal Care: After delivery, mothers should receive adequate support and guidance on breastfeeding, newborn care, and postpartum recovery. It is important to monitor for any signs of postpartum depression or complications.</p>
      </div>

      <div className="mt-4">
        <h3 className="text-md font-semibold text-slate-800 dark:text-slate-100 mb-2">Quiz:</h3>
      ...
      {submitted && (
        <div className="mt-4">
          <h3 className="text-md font-semibold text-slate-800 dark:text-slate-100">Quiz Results:</h3>

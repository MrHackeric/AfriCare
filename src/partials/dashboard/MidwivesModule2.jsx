...
function HighRiskPregnanciesModule() {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-5">
      <h2 className="text-xs text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">Module 2: High-Risk Pregnancies</h2>
      ...
      <div className="mb-6">
        ...
        <button
          ...
          className="text-xs bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700"
          disabled={showResults}
        >
          Submit Quiz
        </button>
      ...
      {/* Activities */}
      <div className="mb-6">
        <h3 className="text-xs text-md font-semibold text-slate-800 dark:text-slate-100 mb-2">Activities</h3>
